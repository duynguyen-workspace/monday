                ...
                <Col md={14} span={24}>
                    <div className="flex flex-col text-center h-full">
                        <div className="flex flex-col flex-grow justify-center align-middle">
                            <div className="upper-content mx-auto ">
                                <div className="mb-12">
                                ...
                                <div className="">
                                    <button className="w-full border border-slate-500 rounded transition-all hover:bg-blue-200 hover:bg-opacity-10">
                                        <div className="flex justify-center align-middle md:p-3 p-2">
                                            ...
                                            <p className="md:text-lg text-base font-light ps-2">Continue with Google</p>
                                        </div>
                                    </button>

                                    <Divider>Or</Divider>

                                    <input className="w-full block md:text-lg text-base sm:p-3 p-2 ps-4 mb-4 border border-slate-300 rounded transition-all focus:border-blue-500 hover:border-black" placeholder="name@company.com"></input>
                                
                                    <button className="w-full md:p-3 p-2 mb-5 bg-blue-600 sm:text-lg text-base text-white border border-slate-500 rounded transition-all" size="large">Continue</button>
                                </div>
